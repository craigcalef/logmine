...
class ContinuousMapReduce:
    ...
    def map(self, inputs, chunksize=1):
        """Perform a continuous map process by calling map multiple times 
        ...
        try:
            ...
            self.all_responses += map_responses 
    ...
    def reduce(self):
        """Finally reduce and return the mapped inputs
        ...
        """
            ...
            partitioned_data = self.partition(itertools.chain(*this.all_responses))
